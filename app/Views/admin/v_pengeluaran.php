...
<html lang="en">
	...
	<form action="<?= site_url('admin/pengeluaran') ?>" method="post" enctype="multipart/form-data">
		<div class="card-body">
		...
		<div class="card-footer">
			...
			<a href="<?= site_url('admin/pengeluaran') ?>" title="Kembali" class="btn btn-secondary">Batal</a>
		</div>
	</form>
</div>
       ...
       function formatkeluar(angka, prefix) {
         ...
         return prefix == undefined ? keluar : (keluar ? 'Rp ' + keluar : '');
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-content-between small">
